...
function cLoveFont (caller_name,a,b) {
	...
	this.init_default_font = function (image_or_filename,glyphs) {
		...
		if (kDefaultImageFontURL) {
			this.init_image_font(kDefaultImageFontURL," abcdefghijklmnopqrstuvwxyz0123456789.!'-:Â·");
...
//		String glyphs = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
	...
	public LuanObjFont (LuanGraphics g) throws IOException { this(g,new LuanObjImage(g, R.raw.imgfont_w)," abcdefghijklmnopqrstuvwxyz0123456789.!'-:Â·"); this.g = g; bForceLowerCase = true; } 
